...
```
Generally speaking, Pink Lady Apples are purchased earlier in the day than Coffee Ice Cream.
...
min_max + snowfall
```
Within the time range, the highest number of days had a minimum temperature between ~0-15 degrees Celsius and a maximum temperature between ~0-30 degrees. Across the time range, the most common level of snowfall measured per day was between 0-30 mm. There was also a peak around 40-50mm. 
